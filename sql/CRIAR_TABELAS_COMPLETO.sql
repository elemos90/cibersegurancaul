-- ============================================================================
-- SCRIPT COMPLETO: Criar Todas as Tabelas do Portal de Cibersegurança
-- ============================================================================
-- COMO USAR:
...
-- 2. TABELA: incident (incidentes de segurança)
-- ----------------------------------------------------------------------------
...
-- 3. TABELA: policy (políticas de segurança)
-- ----------------------------------------------------------------------------
...
-- 4. TABELA: risk (riscos de segurança)
-- ----------------------------------------------------------------------------
...
-- 5. TABELA: evidence (evidências/anexos)
-- ----------------------------------------------------------------------------
...
SELECT 
  ...
  (SELECT COUNT(*) FROM information_schema.tables 
   ...
   AND table_name IN ('user', 'incident', 'policy', 'risk', 'evidence')) as Tabelas_Criadas
